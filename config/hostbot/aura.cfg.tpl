...
# custom; el techo duro de 1.27b son 128 MiB y arriba de ~2-3 MB la
...
# juego real que este build de Aura acepta clientes 1.27b con este valor.
...
# y solo se pueden confirmar conectando el bot a un PvPGN con clientes 1.27b.
...
# (war3.exe/storm.dll/game.dll de 1.27b). passwordhashtype pvpgn es lo
