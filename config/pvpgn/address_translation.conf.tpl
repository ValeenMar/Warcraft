...
###############################################################################
# Regla generada por wc3-classic-revival (render desde .env):
# el w3route escucha en 0.0.0.0:6200 pero a los clientes externos hay que
# anunciarles la IP publica del VPS. Sin esta linea, los clientes de afuera
# reciben 0.0.0.0:6200 y las partidas PG/AT no funcionan.
# Las partidas custom hosteadas por el bot NO pasan por aca (el bot anuncia
# su propia IP via bot_bindaddress/hostport).
0.0.0.0:6200      ${WC3_PUBLIC_IP}:6200      NONE           ANY
