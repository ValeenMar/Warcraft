...
#                                                                            #
# Examples:                                                                  #
# storage_path = "file:mode=plain;dir=/opt/wc3/pvpgn/var/pvpgn/users;clan=/opt/wc3/pvpgn/var/pvpgn/clans;team=/opt/wc3/pvpgn/var/pvpgn/teams;default=/opt/wc3/pvpgn/etc/pvpgn/bnetd_default_user.plain"
...
# storage_path = "sql:mode=sqlite3;name=/opt/wc3/pvpgn/var/pvpgn/users.db;default=0;prefix=pvpgn_"
# storage_path = "sql:mode=odbc;name=PVPGN;prefix=pvpgn_"
#----------------------------------------------------------------------------#

storage_path = "sql:mode=mysql;host=${WC3_DB_HOST};name=${WC3_DB_NAME};user=${WC3_DB_USER};pass=${WC3_DB_PASS};default=0;prefix=pvpgn_"
...
filedir     = "/opt/wc3/pvpgn/var/pvpgn/files"
scriptdir   = "/opt/wc3/pvpgn/var/pvpgn/lua"
reportdir   = "/opt/wc3/pvpgn/var/pvpgn/reports"
chanlogdir  = "/opt/wc3/pvpgn/var/pvpgn/chanlogs"
userlogdir  = "/opt/wc3/pvpgn/var/pvpgn/userlogs"
i18ndir     = "/opt/wc3/pvpgn/etc/pvpgn/i18n"
issuefile   = "/opt/wc3/pvpgn/etc/pvpgn/bnissue.txt"
channelfile = "/opt/wc3/pvpgn/etc/pvpgn/channel.conf"
adfile      = "/opt/wc3/pvpgn/etc/pvpgn/ad.json"
topicfile   = "/opt/wc3/pvpgn/etc/pvpgn/topics.conf"
ipbanfile   = "/opt/wc3/pvpgn/etc/pvpgn/bnban.conf"
mpqfile     = "/opt/wc3/pvpgn/etc/pvpgn/autoupdate.conf"
logfile     = "/opt/wc3/pvpgn/var/pvpgn/bnetd.log"
realmfile   = "/opt/wc3/pvpgn/etc/pvpgn/realm.conf"
maildir     = "/opt/wc3/pvpgn/var/pvpgn/bnmail"
versioncheck_file = "/opt/wc3/pvpgn/etc/pvpgn/versioncheck.json"
mapsfile    = "/opt/wc3/pvpgn/etc/pvpgn/bnmaps.conf"
xplevelfile = "/opt/wc3/pvpgn/etc/pvpgn/bnxplevel.conf"
xpcalcfile  = "/opt/wc3/pvpgn/etc/pvpgn/bnxpcalc.conf"
#pidfile    = "/opt/wc3/pvpgn/var/pvpgn/bnetd.pid"
ladderdir   = "/opt/wc3/pvpgn/var/pvpgn/ladders"
command_groups_file = "/opt/wc3/pvpgn/etc/pvpgn/command_groups.conf"
tournament_file = "/opt/wc3/pvpgn/etc/pvpgn/tournament.conf"
statusdir   = "/opt/wc3/pvpgn/var/pvpgn/status"
aliasfile   = "/opt/wc3/pvpgn/etc/pvpgn/bnalias.conf"
anongame_infos_file = "/opt/wc3/pvpgn/etc/pvpgn/anongame_infos.conf"
DBlayoutfile = "/opt/wc3/pvpgn/etc/pvpgn/sql_DB_layout.conf"
supportfile = "/opt/wc3/pvpgn/etc/pvpgn/supportfile.conf"
transfile   = "/opt/wc3/pvpgn/etc/pvpgn/address_translation.conf"
customicons_file = "/opt/wc3/pvpgn/etc/pvpgn/icons.conf"
...
location = "${WC3_SERVER_LOCATION}"
description = "${WC3_SERVER_DESCRIPTION}"
url = "${WC3_SERVER_URL}"
contact_name = "${WC3_CONTACT_NAME}"
contact_email = "${WC3_CONTACT_EMAIL}"
